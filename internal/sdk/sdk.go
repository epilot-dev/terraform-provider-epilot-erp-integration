...
// Generated from OpenAPI doc version 0.24.0 and generator version 2.795.8
...
type SDK struct {
	...
	Erp *Erp
	// Endpoints to trigger ERP related actions
	Trigger *Trigger
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.15.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.15.0 2.795.8 0.24.0 github.com/epilot-dev/terraform-provider-epilot-erp-integration/internal/sdk",
