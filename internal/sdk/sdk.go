...
// Generated from OpenAPI doc version 1.5.12 and generator version 2.924.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.23.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.23.0 2.924.0 1.5.12 github.com/epilot-dev/terraform-provider-epilot-erp-integration/internal/sdk",
