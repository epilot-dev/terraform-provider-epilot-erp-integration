...
// Generated from OpenAPI doc version 1.0.3 and generator version 2.879.13
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.23.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.23.0 2.879.13 1.0.3 github.com/epilot-dev/terraform-provider-epilot-erp-integration/internal/sdk",
