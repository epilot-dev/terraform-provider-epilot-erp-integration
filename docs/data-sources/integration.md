...
- `schema` (String) For 'relations' and 'reverse-relations' modes: The schema of the entity to find
(e.g., 'billing_account'). Not used for 'query' mode.
...
- `unique_ids` (Attributes List) For 'relations' and 'reverse-relations' modes: How to identify the scope entity
from the payload. Not used for 'query' mode. (see [below for nested schema](#nestedatt--use_cases--inbound--configuration--entities--scope--unique_ids))
